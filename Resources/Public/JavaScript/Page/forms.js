$(document).ready(function() {
  ...
  $('form input[type="radio"]').after('<i class="helper"></i>');
  $('form input[type="radio"]').parent().parent().parent().after('<i class="validation-icon">' + alertIcon + '</i>');
  ...
  var elements = $('form input[type="text"],form input[type="email"],form input[type="date"],form input[type="tel"],form input[type="url"],form input[type="file"],form input[type="checkbox"],form textarea, form select');
