<INCLUDE_TYPOSCRIPT: source="FILE:EXT:pagelist/Configuration/TypoScript/constants.ts">

# to override default CSS path
pagelist.styles = EXT:microtemplate/Extensions/pagelist/Resources/Public/Styles/pagelist.css
